...
define $(PKG)_BUILD
    ...
    $(SED) -i 's,set(_Qt5Network_LIB_DEPENDENCIES \"Qt5::Core\"),set(_Qt5Network_LIB_DEPENDENCIES \"Qt5::Core;ssl;crypto;crypt32;ws2_32;iphlpapi\"),g' '$(PREFIX)/$(TARGET)/qt5/lib/cmake/Qt5Network/Qt5NetworkConfig.cmake'
endef
